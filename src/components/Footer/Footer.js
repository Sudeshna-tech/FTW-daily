            ...
            <div className={css.organization} id="organization">
              ...
              <div className={css.organizationInfo}>
                <p className={css.organizationDescription}>
                  <FormattedMessage id="Made in Asia for the World" />
                </p>
                <p className={css.organizationCopyright}>
                  <NamedLink name="LandingPage" className={css.copyrightLink}>
                    <FormattedMessage id="Copyright @ Callbit 2020" />
                  </NamedLink>
                </p>
              </div>
            </div>
              ...
              <ul className={css.list}>
                <li className={css.listItem}>
                  <NamedLink name="NewListingPage" className={css.link}>
                    <FormattedMessage id="For Candidates" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink name="AboutPage" className={css.link}>
                    <FormattedMessage id="Browse Jobs" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink name="LandingPage" className={css.link}>
                    <FormattedMessage id="Add Resume" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink name="LandingPage" className={css.link}>
                    <FormattedMessage id="Job Alerts" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink name="AboutPage" to={{ hash: '#contact' }} className={css.link}>
                    <FormattedMessage id="My Bookmarks" />
                  </NamedLink>
                </li>
              </ul>
            </div>
              ...
              <ul className={css.list}>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="For Employers" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Browse Candidates" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Post a Job" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Post a Task" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Plans and Pricing" />
                  </NamedLink>
                </li>
              </ul>
            </div>
